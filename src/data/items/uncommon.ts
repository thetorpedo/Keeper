...
export const uncommonItems: Ability[] = [
    ...
    },
    {
        ...
        "description": "This is a book of 10 magic stamps produced by various underground organizations. When a stamp is removed from the book and placed on a map of a town or city, it reveals on the map the name and location of one of each of the following: \n\n• An underground marketplace where stolen goods are traded. \n• A popular safe house for criminals. \n• A popular establishment where illegal services are offered."
    ...
    },
    {
        ...
        "effects": [
            {
                "cost": 2,
                "description": "When you set the boat in water with enough clearance around it to fully expand, you can activate it to transform into a real, working sloop. You may have the boat return to its paper model form at any time by patting the boat on the side and giving it some words of encouragement."
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "effects": [
            {
                "cost": 4,
                "description": "You read from the book."
            }
        ],
        "rollTable": [
            {
                "value": 20,
                "description": "Well, it turns out the author of this book was actually a genius. You learn a legendary ability of the Guide’s choice from either The Magician or The Wizard. The book’s power fades and cannot be used again."
            },
            {
                "value": "17-19",
                "description": "You learn the location of a legendary magic item."
            },
            {
                "value": "14-16",
                "description": "You accidentally turn yourself into a sheep for the next hour. You retain your current hit points but can’t speak or use abilities."
            },
            {
                "value": "11-13",
                "description": "The book releases a deafening shockwave, shattering all glass objects within 1 kilometer."
            },
            {
                "value": "8-10",
                "description": "You hear the howling of demons in your mind. The book’s real owner senses your location. They are coming for you..."
            },
            {
                "value": "5-7",
                "description": "You glimpse ultimate horror and are overcome with dread when the Dim Grimoire is nearby. You can’t use your abilities when the book is near."
            },
            {
                "value": "2-4",
                "description": "You accidentally absorb an NPC spirit that was imprisoned in the book. It cannot control you, but it can speak to you in your mind and witness everything you do. It can only be removed with the Banish ability."
            },
            {
                "value": 1,
                "description": "The book explodes in brilliant prismatic fire and is destroyed, dealing 4 damage to every creature nearby."
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "rollTable": [
            ...
            { "value": "15-19", "description": "Your hit points are fully restored." },
            ...
            { "value": "4-5", "description": "You are affected by the Nox spell for 1 hour. The Guide chooses the effects." },
            { "value": "2-3", "description": "You are hit for 6 hit points." },
    ...
    },
    {
        ...
        "description": "This is a small glass dropper filled with a gray magic liquid. There is enough liquid inside to dispense 6 bead-sized drops. A single drop is enough to permanently bond two things together within 10 seconds. For example, by placing a drop of Permanent Solution inside a weapon’s scabbard and then putting the weapon back inside, you can make it impossible to remove the weapon from the scabbard.\n\n There is no limit to the size of the things you can bond, but the solution does not make them stronger; if enough force is applied, the bonded objects may break around the point of contact where they are bonded. The bond can only be broken with the Undo spell."
    ...
    },
    {
        ...
        "effects": [
            {
                "cost": 3,
                "description": "When you activate the ram, you can use it to hit and break a wooden door of any size. The door shatters into tiny splinters."
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "effects": [
            {
                "cost": 2,
                "description": " You speak into the horn. It has the same effects of the Aura’s Silvery Broadcast spell."
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "effects": [
            {
                "cost": 1,
                "description": "While wearing the gauntlet, you can grab a bladed weapon that is about to strike you. Grabbing the blade prevents an enemy from hitting you, even if their attack was successful. You may take the weapon from them."
            }
        ]
    },
    {
    ...
    },
    {
        ...
        ,
        "rollTable": [
            { "value": 20, "description": "The broom accepts you, becoming a Tamed Magic Broom. You can now safely activate it for 2 AP whenever you want, allowing you to fly with it for 1 hour." },
            { "value": "11-19", "description": "The broom decides it is in the mood to fly and lets you ride and direct it for the next 10 minutes." },
            { "value": "6-10", "description": "The broom thinks you want it to clean something. It begins floating around, sweeping up any loose bits into piles." },
            { "value": "2-5", "description": "The broom decides it is in the mood to fly, but not with you. It shoots up into the air, ejecting you forcefully, and pursues its own agenda for the next hour before returning to you." },
            { "value": 1, "description": "The broom tires of you and your games. It flies off into the distance. You don’t know if it will return to you." }
        ]
    },
    {
