...
export const rareItems: Ability[] = [
    ...
    },
    {
        ...
        "effects": [
            {
                "cost": 1,
                "description": "This is an unusually large belt. When you wear it, you feel unusually strong. You channel the belt’s magic power, granting you the ability to lift things as heavy as elephants for the next 10 seconds."
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "effects": [
            {
                "cost": 2,
                "description": "This greathammer is imbued with radiant light by an archmage who worshipped their world’s north star. You raise the hammer in the sky and utter the phrase: “Day unto dark, dark unto day: I call for the light from on high.” When activated, the hammer emits the blinding light of a star. Any creature that can see the light of the hammer and has their eyes open is blinded for the next minute."
            }
        ]
    },
    {
        ...
        "effects": [
            {
                "cost": 1,
                "description": "This is a small, golden, magic tally counter that can count as high as 7 digits. Whenever a person dies nearby, the counter automatically increases by 1. The Death Adder reveals the cause of death for its most recent tally."
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "effects": [
            {
                "cost": 0,
                "description": "This magic dress deceptively appears to have no pockets. In fact, it has many. When wearing the dress, you may press an item against it that you wish to stash. A seam silently opens, creating a portal to a pocket-sized shadow plane. When the item you wish to pocket is deposited, the seam closes. The seam reopens any time you wish to retrieve the item. You may store up to 10 items in the dress, and these items do not count against your inventory limit. If the dress is ripped apart or destroyed, any items stored inside immediately fall out."
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "effects": [
            {
                "cost": 0,
                "description": "This is a brilliant stick of chalk that flickers as if a candle is inside of it. You can use the chalk to draw a closed shape. As soon as you close the drawing, the area within the shape becomes a portal that teleports anything that passes through it. You must draw a second portal for the first one to become active. When you have two portals, they become a gateway to one another. The chalk crumbles to dust as soon as the two portals become active."
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "effects": [
            {
                "cost": 1,
                "description": "This is a magic crystal ball that’s the size of an apple. Scrying spheres are traditionally stored in velvet pouches and concealed by silken cloths. The sphere makes a noticeable and ongoing ringing sound that echoes nearby when it is uncovered. When you hold the sphere and gaze into it, you can use the Scry spell. You may only activate the sphere once per game session."
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "effects": [
            {
                "cost": 1,
                "description": "The Serpentine Staff is a magic snakewood staff made by ancient druids. A golden ouroboros symbol is etched into the base. You whisper a magic word to the staff, causing it to transform into a viper. The viper is a magical illusion that you control. You share a telepathic bond with the viper and can command it to move, act, and attack. It has 4 hit points and its attacks deal 1 damage. You may have the viper transform back into its staff form at any time. If the viper is killed, it automatically transforms back into the staff."
            }
        ]
    },
    {
