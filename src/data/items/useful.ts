...
export const usefulItems: Ability[] = [
    {
        ...
        "description": "A set of 5 lockpicks that can be used to try to bypass doors and other things with simple locks."
    ...
    },
    {
        ...
        "description": "A 50-foot rope that can automatically coil itself. It can also shrink to the size of a spool of yarn for easy carrying, and expand back to its normal size on its owner’s command."
    ...
    },
    {
        ...
        "description": "A magic flask that automatically replenishes itself with a spirit of your choice. (Choose once.)"
    ...
    },
    {
        ...
        "description": "A powerful candle that can light itself and snuff itself out on its owner’s command. It drips wax but never seems to lose any."
