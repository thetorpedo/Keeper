...
export const bookAbilities: Ability[] = [
    ...
    },
    {
        ...
        rollTable: [
            { value: 20, description: "Everyone arrives safely. You recover the spell’s full AP cost." },
            { value: 11, description: "(11-19) You all arrive safely. Good for you." },
            { value: 6, description: "(6-10) You all arrive. Choose one: you take 7 damage from turbulence, or a magic item you are carrying is destroyed." },
            { value: 2, description: "(2-5) The party arrives safely, but nobody else does. You don’t know where they went. You lose an item you are carrying." },
            { value: 1, description: "The spell fails. Party members are lacerated by an arcane explosion and are each hit for 5 HP. All other travelers are torn apart in a gruesome spectacle. (They die.)" }
        ]
    },
    ...
    // ---------------------------------------------------------
    {
        ...
        rollTable: [
            { value: 20, description: "The spell is violently canceled and its caster is hit for 1 AP." },
            { value: 11, description: "(11-19) The spell is stopped before it is cast." },
            { value: 6, description: "(6-10) The spell misses and hits another nearby creature or target." },
            { value: 2, description: "(2-5) The spell takes effect normally." },
            { value: 1, description: "You accidentally amplify the spell. If it is a harmful spell, the damage is doubled." }
        ]
    },
    {
        id: 'wiz_reflect',
        ...
        rollTable: [
            { value: 11, description: "(11-20) The caster is hit by their own spell, instead of you." },
            { value: 6, description: "(6-10) The spell reflects off of you but misses its caster." },
            { value: 1, description: "(1-5) The spell reflects off of you but hits a nearby party member instead." }
        ]
    },
    {
        id: 'wiz_enscroll',
    ...
    },
    {
        ...
        effects: [
            {
                cost: 4,
                description: 'For the next hour, you can see through all magical deceptions. See reveals the world to you in several ways: you see anything that’s invisible, you know if something is an illusion, and you may see the true form of anything that has been altered by magic.'
            }
        ]
    },
    {
    ...
    },
    {
        ...
        path: 'Trickery',
        name: 'Undo',
        description: 'You speak a word of power, reversing the fate of a nearby object. The spell cannot be used to affect living things. The thing you are undoing must be the discrete result of another creature’s effort. For example, you might undo a creature’s shoelaces, unthread a garment, cause a piece of furniture to fall apart, or revert a sculpture to a block of marble. Choose how much effort to undo each time you use this spell:',
        effects: [
            { cost: 1, description: 'Up to 1 minute of effort.' },
            { cost: 2, description: 'Up to 1 day of effort.' },
            { cost: 3, description: 'Up to 1 week of effort.' },
            { cost: 4, description: 'Any amount of effort.' }
        ]
    },
