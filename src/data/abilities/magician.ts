...
export const magicianAbilities: Ability[] = [
    ...
    },
    {
        ...
        "effects": [
            {
                "cost": 3,
                "description": "Option A: You make a nearby creature or object invisible for the next minute. If it is a creature, everything they are wearing and carrying also becomes invisible. If a creature attacks while invisible, they reappear."
            },
            {
                "cost": "X",
                "description": "Option B: X AP. Add 1 AP for each creature or object you target with the spell beyond the first."
            }
        ]
    },
    {
        ...
        "effects": [
            {
                "cost": 1,
                "description": "You vanish momentarily, reappearing with two illusory duplicates at your side. Your duplicates travel alongside you and perfectly mimic all of your movements. If a creature attempts to target you, the Guide must flip a coin. If it turns up “heads,” you are targeted; on “tails” one of your duplicates is targeted. If one of your duplicates takes damage, it disappears."
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "effects": [
            {
                "cost": 1,
                "description": "You briefly gain the ability to see beyond physical reality. For the next hour, you are able to see the following: Magic. A faint aura surrounds any person or object currently affected by magic. Illusion. Any illusory creature or object slightly flickers, but you do not see its true form."
            }
        ]
    },
    {
        ...
        "effects": [
            {
                "cost": 0,
                "description": "Option A: You telepathically send a message to a nearby creature. They know you are speaking from within their mind, but they hear you as if you were speaking out loud."
            },
            {
                "cost": 1,
                "description": "Option B: You create a link with the creature that allows them to respond to your whisper. If they respond, you may have a telepathic conversation with them for the next minute."
            }
        ]
    },
    {
        ...
        "effects": [
            {
                "cost": 1,
                "description": "Option A: Choose a creature you have met before. You must know the general area where they are presently located. You may communicate with each other telepathically for up to 1 minute."
            },
            {
                "cost": 4,
                "description": "Option B: You can create the telepathic link, even if you do not know where the creature is located. They can be anywhere."
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "rollTable": [
            {
                "value": 20,
                "description": "If you roll a 20, you learn the creature’s worst fear. They become permanently haunted by it in every waking moment. Over time, their personality is destroyed, and they become unresponsive to others."
            },
            {
                "value": "11-19",
                "description": "On 11 to 19, you learn the creature’s worst fear. You may then conjure the image of this fear in their mind’s eye, paralyzing them with dread for the next 10 minutes. They cannot act, except to flee danger."
            },
            {
                "value": "6-10",
                "description": "On 6 to 10, you learn the creature’s worst fear, but they reject you from their mind before you can conjure the fear."
            },
            {
                "value": "2-5",
                "description": "On 2 to 5, you learn the creature’s worst fear, but it paralyzes you with dread for the next 10 minutes. During this time, you are unable to use abilities."
            },
            {
                "value": 1,
                "description": "On a 1, when confronting the creature’s fear, you become permanently haunted by it. You must choose an additional character flaw. You can only lift the fear by having the Liberate spell cast on you."
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "effects": [
            {
                "cost": 4,
                "description": "You summon four prismatic bolts that sparkle brilliantly. You may direct each bolt toward any target you can see. The bolts each hit for 2 HP. If all four hit a single creature, the creature is affected by your Mesmerize ability."
            }
        ]
    },
    {
        ...
        "effects": [
            {
                "cost": 2,
                "description": "You twirl your finger as if you are unwinding a spool of yarn. Starting with a single creature nearby that you can see, you create a cascading wave of magic mischief that loosens anything fastened or tightened around nearby creatures. For example: • Bags become unclasped and spill out their contents. • Shoelaces become untied, belts unbuckled, and shirts unbuttoned. • Pets become unleashed."
            }
        ]
    },
    {
        ...
        "effects": [
            {
                "cost": 3,
                "description": "You summon a cherry-sized elastic ball in your hand. When you throw the ball, it bounces off everything it touches, avoiding creatures. Each time the ball bounces, it accelerates slightly, traveling faster and faster until it escapes into the atmosphere after 1 minute. The ball’s brief reign of terror shatters pottery, glass, light furniture, and most other fragile things in your scene. What a shame."
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "effects": [
            {
                "cost": 5,
                "description": "You conjure a fantastic hot air balloon from another dimension that can fit you and your party. You must be outdoors and standing in a clearing with room for the balloon to form. The balloon is 30 meters tall and can look like anything you want. It’s piloted by a small, illusory creature that can talk to you and your crew and take instructions. (The standard creature is a red panda wearing goggles, but you may choose any similarly sized creature you want.) The pilot remembers you and where you’ve been if you cast the spell again. The balloon is powered by a flaming sphere above the carriage that adjusts its intensity based on your commands. The balloon can soar as high as the tallest mountain peaks and move at up to 30 kilometers an hour. The carriage has 40 hit points, and the balloon has 10 hit points. You may dismiss the balloon at any time; it vanishes with its pilot and returns home."
            }
        ]
    },
    {
