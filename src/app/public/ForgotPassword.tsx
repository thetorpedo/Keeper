    ...
    const onPasswordReset = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (error instanceof Error) {
                showAlert(error.message, "Reset Error", "error");
            }
        }
    };
        ...
        <main className="flex items-center justify-center bg-purple/30 min-h-screen p-5">
            ...
            <section className="w-full max-w-md p-8 mx-5 space-y-8 border bg-white shadow-btn2">
                <div className="absolute">
                    <Link to="/login" className="text-5xl hover:opacity-70">
                ...
                <div className="text-center">
                    <Link
                        to="/"
                        className="text-5xl font-extrabold tracking-tight hover:opacity-70 font-alegraya "
                    >
                        Keeper
                    </Link>
                    <p className="mt-2 text-lg">
                        You will receive instructions on your e-mail for
                        resetting your password.
                    </p>
                </div>
                <form onSubmit={onPasswordReset} className="mt-8 space-y-6">
                    <div className="space-y-3">
                        ...
                        {errorMessage && (
                            <span className="text-red-600 my-2 font-bold">
                                {errorMessage}
                            </span>
                        )}
                    </div>
                    ...
                    <div className="flex justify-center gap-5">
                        <Button isImportant type="submit">
                            Send
                        </Button>
                    </div>
                </form>
