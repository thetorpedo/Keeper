...
export default function CharacterProfile({ characterData, updateField }: CharacterProfileProps) {
    return (
        ...
        <div className="max-sm:text-lg/7 text-xl">
            <p>Hello,</p>
            <p >My name is <EditableText value={characterData.name} onSave={(val) => updateField('name', val)}/>, (<EditableText value={characterData.pronouns} onSave={(val) => updateField('pronouns', val)}/>).</p>    
