        ...
        <Dialog>
            ...
            className="relative h-38 z-9 cursor-pointer -mt-23 overflow-hidden w-full border-b group bg-white rounded-t-lg hover:h-50 hover:-mt-35 transition-all duration-300">
                ...
                <div className="w-full h-full relative rounded-t-lg border border-b-0 border-gray-400 p-2.5 pt-2">
                    ...
                    >
                        {isSelected ? <X className="mx-auto size-5"/> : <Plus className="mx-auto size-5"/>}
                    </Button>
            ...
            <DialogContent showCloseButton={false} className="sm:max-w-md max-h-[80vh] gap-0 z-100 overflow-y-auto font-alegraya-sans p-0 font-medium text-lg">
                ...
                <div className="flex justify-end gap-3 p-4 border-t border-gray-200">
                    ...
                    <Button 
                        onClick={onClick} 
                        className={isSelected ? 'bg-purple hover:bg-purple text-black border w-full  rounded-lg text-lg' : 'w-full rounded-lg grow text-lg'}
                    >
