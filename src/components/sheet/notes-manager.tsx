...
export default function NotesManager({
  ...
  const handleSave = () => {
    ...
    const noteToSave = {
      ...currentNote,
      title:
        currentNote.title.trim() === "" ? "Untitled Note" : currentNote.title,
      updatedAt: Date.now(),
    };
          ...
          {view === "list" && (
            <div className="flex flex-col h-full">
              <div className="flex justify-between items-center sm:p-4 pt-5 border-gray-300">
                <span className="font-alegraya-sans font-bold lowercase text-2xl">
                  Notes
                </span>
                <Button
                  onClick={handleCreateNew}
                  className="px-3 py-1 mr-1 flex items-center text-base"
                >
            ...
            <div className="flex flex-col h-full sm:p-2 bg-white">
              <div className="flex justify-between items-center pb-2 sm:p-2  border-gray-300 ">
                <Button
                  ...
                  className="p-1.5! shadow-none border hover:shadow-btn! cursor-pointer  transition-all text-gray-600"
                >
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    onClick={handleSave}
                    className="px-3! py-1 p-2! flex items-center text-sm shadow-none bg-purple hover:shadow-btn! text-black border-black"
                  >
